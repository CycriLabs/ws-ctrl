...
│   ├── config
│   │   ├── datasources
│   |   |    ├── add-datasource-offline.cli
│   │   ├── development
│   |   |    ├── ...
│   │   ├── docker
│   |   |    ├── .env
│   |   |    ├── docker-compose-cxc.yml
...
| `config/datasources/add-datasource-offline.cli` | this file will be used to potentially configure datasources to a Wildfly server                                                                                  |
...
| `config/docker`                                 | Docker configuration files for the workspace; the files are copied to the root directory and will be used to start backing services as well as platform services |
...
| `config/nginx`                                  | Nginx configuration files for the workspace; the files are copied to the root directory and will be used to configure the Nginx server                           |
| `config/postgresql/postgres-init-user-db.sql`   | PostgreSQL configuration file that is used to create all necessary databases                                                                                     |
